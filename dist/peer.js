...
function Peer(id, options) {
  ...
  // validate user-id and password if user-id is specified
  //if (id && !util.validatePassword(id, options.password)) {
  //  this._delayedAbort('Unauthorized', "Invalid username or password");
  //}
...
Peer.prototype._initializeServerConnection = function() {
  var self = this;
  this.socket = new Socket(this.options.secure, this.options.host, this.options.port, this.options.path, this.options.key, this.options.password);
 ...
 */
function Socket(secure, host, port, path, key, password) {
  if (!(this instanceof Socket)) return new Socket(secure, host, port, path, key, password);
...
Socket.prototype._startXhrStream = function(n) {
  try {
    ...
    params="username="+this.id+"&password="+this.password;
    console.log("post_params: "+params);
    this._http.send(params);
